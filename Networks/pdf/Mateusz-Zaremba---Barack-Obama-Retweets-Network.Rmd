...
<!-- definitions of the network metrics used any code should be provided in the Appendix of the report or as separate files; -->
<!-- Comment -->
...
## Metadata
The following metadata can be found on the [http://networkrepository.com/rt-barackobama.php](http://networkrepository.com/rt-barackobama.php) website: 
|   | Metadata  | |
| - | -| - |
