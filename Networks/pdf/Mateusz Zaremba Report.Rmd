...
Interesting results were achieved using `Gephi` (Gephi.org, 2019), were it is clearly visible that there is one central node in the network (Barack Obama); there is also a small cluster which was marked with an orange frame:
```{r, out.width="0.95\\linewidth", include=TRUE, fig.align="center", echo=FALSE}
knitr::include_graphics("/Users/mateuszzaremba/dev/R/Networks/pdf/gephi\ copy.pdf")
```
