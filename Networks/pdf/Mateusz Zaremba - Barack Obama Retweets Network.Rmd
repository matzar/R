...
# Methods
<!-- What data preparation did they have to carry out; -->

<!-- which metrics did they use to analyse the data;  -->
...
## Data Preparation
The data was prepared using R programming language and RStudio software; after downloading it from the code
