...
```{r, out.width="0.5\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Graph with node sizing and colouring"), echo=FALSE}
...
```{r, out.width="0.5\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Colour - closeness. Size - betweenness"), echo=FALSE}
...
```{r, out.width="0.5\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Plotted using Large Graph Layout"), echo=FALSE}
