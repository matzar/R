...
## Data Exploration
For a sake of data exploration and to see if there are any visible trends, the means from *M1*, *M2*, *M3* and *M4* assessment categories were plotted with data smoothing, set on basis of sex and subject:
