...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, error = FALSE, tidy = TRUE, cache = FALSE, fig.cap = "...")
```
...
```{r mm2}
knitr::kable(
  head(mm2[,c("age", "sex", "subject", "M1", "M2", "IR", "EJ", "MG")]), booktabs = TRUE,
  caption = 'Students at risk found using conservative criteria.'
)
```

```{r mm3, fig.cap="Students at risk found using mitigated criteria"}
knitr::kable(
  head(mm3[,c("age", "sex", "subject", "M1", "M2", "IR", "EJ", "MG")]), booktabs = TRUE,
  caption = 'Students at risk found using mitigated criteria.'
)
```
