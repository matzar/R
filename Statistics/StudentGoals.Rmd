...
## Initial Data
This is how the data looked like before cleaning:
...
## Clean Data
This is how the date looked like after cleaning:
...
$$ \hat{p} \pm Z\sqrt{\frac{\hat{p}(1 - \hat{p})}{n}} = 0.0032 \pm $$
...
The upper end of the confidence interval for a population is `r ci_up[,]`, and the bottom end is `r ci_down[,]`, which gives us CI equal to (`r ci_up[,]`, `r ci_down[,]`). This mean we could say with 95% confidence the percentage of the times we should expect to find a student at risk is between 0.7% and 0%.
