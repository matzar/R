...
To test the hypotheses, a mean for each assessment category was computed and saved for each individual student. This resulted in 7 extra columns added to the original data set, which an example of can be seen below:

```{r}
dat_tibble[1:5, 20:26]
```
