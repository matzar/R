...
Random order (6, 12, 11, 1, 7, 2, 10, 8, 5, 3, 9, 4) was given to use in the survey's instructions. 

The students were presented with the questions in a randomized order. Becasue the survey's instruction gave us the random order, it was assumed that the collected data was put into the table in the order that student's were presented with, to be later derandomized. It was also assumed that the data had not been derandomized so such process was conducted, i.e., *question 6* from the *Performance avoidance* category is numbered *1* in the survey and in the data set. 
*question 12* from the *Mastery avoidance* category is numbered *2* in the survey and in the set, and so on. This also meant that in the process of derandomization previous lower case ***q*** letters in the column names, were changed to upper case ***Q***. E.g. of derandomization and renaming would be ***q****1* becoming ***Q****6*.

*Table 4* inlustrates the entire process:

| |
| - | - | - | - | - | - | - | - | - | - | - | - | - |
Cat. | Performance approach | | | Performance avoidance | | | Mastery approach | | |  Mastery avoidance | | |
...
The survey's instructions provided 7 assessment categories. The table below presents all the 7 categories with my own label and interpretation, which is based on the category's survey questions:
...
Mastery approach | M3 | Students' grade-orientation focus |
Mastery avoidance | M4 | Students' fear of not mastering the course |
Interest | IR | Student expects the course to be interesting |
Enjoyment | EJ | Student expects the course to be enjoyable |
Importance focus | MG | Students' importance focus on understanding vs. grades |
...
To find out if there are any students at risk the following criteria was assumed:

- *Interest* and *Enjoyment* $\leq$ 2
