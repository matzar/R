...
## Hypothesis Testing
To test the hypotheses new means had to be calcualted with regards to both sexes and all the subjets:

- For *Hypothesis 1* testing - the *Importance focus (MG)*
- For *Hypothesis 2* testing - the *Enjoyment (EJ)* and *Interest (IR)*

The graphs below are a visual investigation of the hypotheses using their appropriate categories. All the students are represented; student's sex was made distinguishable by a colour and student's subject was made visible by a shape.
