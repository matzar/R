...
*Table 1* presents the original categories with their properly numbered questions. *Table 2* presents the category, its interpretation (Based on the category's questions) and the matching questions' numbers.
