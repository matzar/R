...
Questions 13, 14 and 15, which were hypotheses testing questions and assessment-categories columns, kept the same order in the survey and in the data set, so they were only renamed for easier data manipulation:
