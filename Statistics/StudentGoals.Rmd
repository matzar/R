...
### Labeling
For easier data manipulation, the assessment-categories columns' names, were changed accordingly labels:
...
In reality, this just meant changing their column names, e.g.: from `interest` to `IG`.
